...
PKG_SOURCE_URL="https://ftp.gnu.org/gnu/make/$PKG_SOURCE"
PKG_SOURCE_MD5SUM=15b012617e7c44c0ed482721629577ac
PKG_DEPENDS=''
...
do_patch() {
	...
	# Re: Strange parallel behavior noted on Linux kernel sources wrt CPU
	# threading,
	# https://lists.gnu.org/archive/html/help-make/2018-07/msg00004.html
	patch -p1 <<"EOF"
